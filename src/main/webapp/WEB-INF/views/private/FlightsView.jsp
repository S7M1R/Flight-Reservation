...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/assets2/css/FlightsView.css">
...
<c:forEach items="${flights}" var="findFlights">
 ...
 <td><a
href="BookTicket?flightId=${findFlights.id}">Select</a>
 </tr>
</c:forEach>
		</div>
	</div>
